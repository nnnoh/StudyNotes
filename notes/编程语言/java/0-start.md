...
`Deque` 接口及其实现提供了一组更完整和一致的LIFO堆栈操作，应优先于此类使用。例如：
...
- 集合中存储的是对象的**引用**。即在 add 后，添加的对象改变将会反映在集合中对应的数据上。
...
![1563865385715](../../../img/java.assets/1563865385715.png)
...
![1563867367896](../../../img/java.assets/1563867367896.png)

![1563867441312](../../../img/java.assets/1563867441312.png)
...
![字节流](../../../img/java.assets/20180513165849464.png)

![字符流](../../../img/java.assets/20180513165030261.png)
